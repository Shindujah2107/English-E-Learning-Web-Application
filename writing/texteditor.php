...
<body onload="initDoc();" style="background-color:white;">
<?php
		include "nav.php";
	?>
<br><br>

<h2 style="color:Green;"><center>Try to describe this picture below..</center></h2>

<br><br>
<img src="unnamed.jpg" alt=""><br><br>
...
<div id="textBox" contenteditable="true"><p>Describe here...</p></div>
<p id="editMode"><input type="checkbox" name="switchMode"   /> <label for="switchBox"></label></p>
