...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>2)Maria likes working with people from all around the .................................... </label></h3>
					<div class="radio">
		<label><input type="radio" name="optradio" value="a">successful</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="b">hard</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">World</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="d">business</label>
	</div>
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="c")
		{
						echo "<div class='alert alert-success' role='alert'>Correct Answer</div>";echo '<a href="p14.php" class="btn">Next>></a>';
		...
		else
		{
			...
			echo '<a href="p14.php" class="btn">Next>></a>';
		}
	}
?>
			</div>
