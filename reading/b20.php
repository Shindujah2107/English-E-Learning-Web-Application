...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>1)As a car .................................... for Motor Ground you will earn £200 a day and you need a driving ....................................</label></h3>
					<div class="radio">
	...
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">salesperson| licence</label>
	</div>
	<div class="radio">
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="c")
		{
						echo "<div class='alert alert-success' role='alert'>Correct Answer</div>";echo '<a href="b21.php" class="btn">Next>></a>';
		...
		else
		{
			...
			echo '<a href="b21.php" class="btn">Next>></a>';
