...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>3)Select the words in the incorrect Room type group</label></h3>
					<div class="radio">
		<label><input type="radio" name="optradio" value="a">meeting</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="b">theatre</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">training day</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="d">team-building event</label>
	</div>
