...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>2)What time does Aziz want to meet?</label></h3>
					<div class="radio">
		<label><input type="radio" name="optradio" value="a">Five o’clock</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="b">Five fifteen</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">Five forty-five</label>
	</div>
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="c")
		{
						echo "<div class='alert alert-success' role='alert'>Correct Answer</div>";echo '<a href="b26.php" class="btn">Next>></a>';
		...
		else
		{
			...
			echo '<a href="b26.php" class="btn">Next>></a>';
		}
	}
?>
			</div>
