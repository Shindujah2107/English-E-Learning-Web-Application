...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>2)I’m an .................................... in my first year at university</label></h3>
					<div class="radio">
	...
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">dormitory</label>
	</div>
	<div class="radio">
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="b")
		{
					echo "<div class='alert alert-success' role='alert'>Correct Answer</div>";	echo '<a href="b18.php" class="btn">Next>></a>';
		...
		else
		{
			...
			echo '<a href="b18.php" class="btn">Next>></a>';
		}
	}
?>
			</div>
