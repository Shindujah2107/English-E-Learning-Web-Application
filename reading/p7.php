...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>3)How long will the interview take?</label></h3>
					<div class="radio">
		<label><input type="radio" name="optradio" value="a">Under an hour</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="b">Just over an hour</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">Over two hours </label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="d">A day</label>
	</div>
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="a")
		{
						echo "<div class='alert alert-success' role='alert'>Correct Answer</div>";echo '<a href="p8.php" class="btn">Next>></a>';
		...
		else
		{
			...
			echo '<a href="p8.php" class="btn">Next>></a>';
		}
	}
?>
			</div>
