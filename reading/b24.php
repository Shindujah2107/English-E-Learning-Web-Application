...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>1)What does Neira want to do?</label></h3>
					<div class="radio">
		<label><input type="radio" name="optradio" value="a">Go to a café</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="b">Go to a cinema</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">Go to a class</label>
	</div>
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="a")
		{
						...
						echo '<a href="b25.php" class="btn">Next>></a>';
