...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>1)The pizza has meat on it.</label></h3>
					<div class="radio">
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="b")
		{
						echo"<div class='alert alert-success' role='alert'>Correct Answer</div>";echo '<a href="b8.php" class="btn">Next>></a>';
		...
		else
		{
			...
			echo '<a href="b8.php" class="btn">Next>></a>';
		}
	}
?>
			</div>
