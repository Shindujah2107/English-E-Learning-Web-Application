...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>4)Not is drinking item</label></h3>
					<div class="radio">
		<label><input type="radio" name="optradio" value="a">coffee</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="b">juice</label>
	</div>
			<div class="radio">
		<label><input type="radio" name="optradio" value="a">roast</label>
	</div>
			<div class="radio">
		<label><input type="radio" name="optradio" value="a">red wine</label>
	</div>
