...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>1)What job did Grace apply for?</label></h3>
					<div class="radio">
		<label><input type="radio" name="optradio" value="a">Head of sales</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="b">Sales manager</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">Sales assistant</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="d">Human resource assistant</label>
	</div>
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="b")
		{
						echo "<div class='alert alert-success' role='alert'>Correct Answer</div>";echo '<a href="p6.php" class="btn">Next>></a>';
		...
		else
		{
			...
			echo '<a href="p6.php" class="btn">Next>></a>';
		}
	}
?>
			</div>
