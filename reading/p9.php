...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>1)Select the words in the correct Facilities group</label></h3>
					<div class="radio">
		<label><input type="radio" name="optradio" value="a">conference</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="b">meeting</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">free Wi-Fi </label>
	</div>
	<div class="radio">
...
echo '<a href="p10.php" class="btn">Next>></a>';
			//echo 'true';
		}
		else
		{
