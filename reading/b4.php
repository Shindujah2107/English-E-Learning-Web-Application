...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>1)The class is at lunchtime in room 7</label></h3>
					<div class="radio">
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="a")
		{
						echo "<div class='alert alert-success' role='alert'>Correct Answer</div>";echo '<a href="b5.php" class="btn">Next>></a>';
		...
		else
		{
			...
			echo '<a href="b5.php" class="btn">Next>></a>';
