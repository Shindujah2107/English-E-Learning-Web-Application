...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>1)Samia and Gregor are going to meet on Saturday</label></h3>
					<div class="radio">
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="a")
		{
						echo "<div class='alert alert-success' role='alert'>Correct Answer</div>";echo '<a href="p2.php" class="btn">Next>></a>';
		...
		else
		{
			...
			echo '<a href="p2.php" class="btn">Next>></a>';
		}
	}
?>
			</div>
