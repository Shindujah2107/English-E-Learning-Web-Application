...
<h1>Answer the following question correct answer will lead you to next question.</h1>
					<h3><label>2)As a French .................................... for LinguaFun you will earn £15 .................................... and you need teaching experience</label></h3>
					<div class="radio">
		<label><input type="radio" name="optradio" value="a">salesperson|an hour</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="b">marketing| a year</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="c">.hospital| registered</label>
	</div>
	<div class="radio">
		<label><input type="radio" name="optradio" value="d">teacher| an hour</label>
	</div>
	...
	if(isset($_POST['submit']))
	{
		...
		if($radval=="d")
		{
						echo "<div class='alert alert-success' role='alert'>Correct Answer</div>";echo '<a href="b22.php" class="btn">Next>></a>';
			//echo 'true';
		...
		else
		{
			...
			echo '<a href="b22.php" class="btn">Next>></a>';
